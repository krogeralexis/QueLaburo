...
<div class="navbar">
    ...
    <div class="container">
        ...
        <a href="index.php?controller=cliente&action=create" class="button">Registrar nuevo cliente</a>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php foreach ($clientes as $cliente): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($cliente['calificaciones']) ?></td>
                        <td>
                            <a href="index.php?controller=cliente&action=edit&id=<?= $cliente['id_cliente'] ?>">Editar</a>
                            |
                            <a href="index.php?controller=cliente&action=delete&id=<?= $cliente['id_cliente'] ?>" class="delete-link" onclick="return confirm('¿Eliminar cliente?')">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
